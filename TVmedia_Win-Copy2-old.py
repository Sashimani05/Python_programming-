...
df_merge_TV2=df_merge_TV2.sort_values(['LastDigit_PV'], 
               ascending=[True])
...
df_merge_TV2=df_merge_TV2.sort_values(['Sec_List_Heading'], 
               ascending=[True])
...
df_merge_SPTV2_col1=df_merge_SPTV2_col1.sort_values(['LastDigit_PV'],ascending=[True])
...
with engine.begin() as connection:
    df_all.to_sql(name="tmp_EditedRecords_Hold",con=engine,schema="dbo",if_exists='replace', chunksize=1000,index=False)
