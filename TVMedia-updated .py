...
Conewave['Detail1']=Conewave['Detail1'].apply(lambda x : x[1:])


# In[649]:


Conewave['Detail1']=Conewave['Sec_List_Heading'] +":" + " "+ Conewave['Detail1']
...
Conewave['Detail1']='#'+ Conewave['Detail1']
...
TVmedia.rename(columns={'F2020_Updated':'CCP','Shows_Name':'Detail1'},inplace=True)
...
TVmedia=TVmedia[["StudyEntryID","SID","VersionID","Category","Super","Tmpl","Time Period","Detail1","Detail2",
...
DB = {'server':'internalSQLdev.mridevops.com','database':'Codebook_Taxonomy','driver':'driver=SQL Server Native Client 11.0'}
...
#TVmedia.to_sql(name="tmp_Spring2021_Test",con=engine,schema="dbo")
